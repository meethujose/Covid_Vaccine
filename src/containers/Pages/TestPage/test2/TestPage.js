...
export default function TestPage(props) {
  ...
  return (
    <div>
      <input class="form-control" id="customFile" {...register("imageInput")} onChange={imageChange} type='file' />
          ...
          <div className='container'>
            <div className='modal' style={{ height: heightModal * 2 }}>
              ...
              <div>
                ...
                <button className = 'btn btn-success' style = {{margin:"auto"}} onClick={getCropData}>
                  Crop Image
                </button>
                </div>
              </div>
